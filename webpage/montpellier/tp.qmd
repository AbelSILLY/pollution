...
df = modpollution.as_df_meteo('../../modpollution/data/data_meteo_mtp.csv')
modpollution.plotmeteo(df,y= 'Température (°C)',titre='Evolution de la Température à Montpellier sur 1 an')
```
