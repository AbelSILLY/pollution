...
À Montpellier seule la station Près d'Arène enregistre la concentration de l'Ozone dans l'air. Cette station est située aux abord de l'autoroute A9, et est donc fortement exposée aux émissions du au trafic routier.    
Il semble nécessaire de rappeler brièvement que l'O3 est issu de réactions entre différents polluants, comme les oxydes d’azote (NOx), et l’effet des rayonnements UV solaires.  



#### Evolution de la concentration d'O3 sur 5 ans 
...
On observe une nette décroissance de la concentration d'O3 dans l'air entre 2019 et 2020. On peut évidemment justifier ce phénomène par la diminution des activités dû à la pandémie. On remarque quand même que les concentrations sont restées assez basses après 2021.

#### Évolution de la concentration d'O3 sur un an 
...
La concentration en 03 varie énormément au long de l'année. On remarque une diminution évidente nette lors des mois d'hivers, contre des concentrations très élevées durant les mois d'été.

#### Températures

Au vu des condition de création de molécule d'Ozone, on se propose de comparer l'ensoleillement à Montpellier au cours de la dernière année.
...
On remarque que la courbe d'ensoleillement et celle de concentration en O3 ont une allure similaire. La corrélation entre l'ensoleillement et la concentration en O3 semble se vérifier.

#### Évolution de la concentration d'O3 le mois dernier 
...
Le polluant NOX regroupe les polluants NO et NO2. Leurs émissions sont principalement dûes au transport et au chauffage des habitations.
