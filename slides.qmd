...
## La Classe
- Load: initialisation avec les url de données et chemin vers 'data'
- Ecrit le contenu des fichiers en binaire pour problème d'encodage
...
- Informatiques
    - La prise en main des outils imposés
...
## Un mot sur le contenu de l'étude
