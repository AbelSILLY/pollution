...
if response.status_code == 200:
    ...
    for feature in data['features']:
        ...
        if nom_polluant in polluants:
            ...
            # Filtrer les données pour toutes les communes
    ...
    fig = px.line(df_moyenne_mensuelle, x=df_moyenne_mensuelle.index, y=polluants,
                  labels={'value': 'Moyenne de la quantité de polluant', 'index': 'Mois de l\'année'},
                  title='Évolution de la moyenne mensuelle de polluants en Occitanie')
